...
export default function Home() {
  ...
  const collectionRoute = "/api/urljavascript";
  const pageName = "News";

  const imageUrls = [
    {
      url: "/News.jpg",
      link: "https://www.bing.com/images/search?form=IARRSM&q=taylor+swift&first=1",
    },
    // Add more images if needed
  ];

  const imageSizes = {
    "/News.jpg": { width: 250, height: 200 },
  ...
  return (
    <div style={styles.container}>
      ...
      <h2 style={styles.title}>
        LWJ&apos;s{" "}
        <span style={{ fontSize: "1.3rem", color: "grey" }}>{pageName}</span>{" "}
        Media Repository
      </h2>
